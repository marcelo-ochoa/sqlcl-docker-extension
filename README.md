...
```bash
$ docker extension install mochoa/sqlcl-docker-extension:23.2.0
Extensions can install binaries, invoke commands and access files on your machine. 
Are you sure you want to continue? [y/N] y
Installing new extension "mochoa/sqlcl-docker-extension:23.2.0"
...
```bash
$ docker extension uninstall mochoa/sqlcl-docker-extension:23.2.0
